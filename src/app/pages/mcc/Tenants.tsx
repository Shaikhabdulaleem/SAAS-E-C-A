...
import { useTenants, type PlanKey, type ServiceKey, type TenantStatus } from '../../contexts/TenantContext';
import {
                      ...
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onClick={() => updateTenant(tenant.id, { status: 'active' })}>
                              Activate
                            </DropdownMenuItem>
